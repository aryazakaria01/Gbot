...
from Gbot import pgram, LOGGER
from Gbot.utils.errors import capture_err
from Gbot.modules.mongo.couples_mongo import get_couple, save_couple
...
today = str(dt()[0])
tomorrow = str(dt_tom())
Queen_PYRO_Couples = filters.command("couples")


@pgram.on_message(Queen_PYRO_Couples)
@pgram.on_edited_message(Queen_PYRO_Couples)
@capture_err
