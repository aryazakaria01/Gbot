...
import asyncio
import telegram
import Gbot.modules.fun_strings as fun_strings

from pyrogram import filters as cutiepii_pyro
from Gbot import SUPPORT_USERS, SUDO_USERS, pgram, QUEEN_PTB
...
@pgram.on_message(cutiepii_pyro.command("meme", "meme@Gbot"))
...
@pgram.on_message(
    cutiepii_pyro.command("hentaimeme", "hmeme", "hmeme@Gbot"))
...
➛ /hug*:* hug someone or get hugged by Qᴜᴇᴇɴ ʙᴏᴛ 愛
➛ /love*:* Checks Love in your heart weather it's true or fake
➛ /kiss*:* Kiss someone or get kissed 
➛ /flirt*:* Qᴜᴇᴇɴ ʙᴏᴛ 愛 will flirt to the replied person or with you
➛ /lewd*:* Qᴜᴇᴇɴ ʙᴏᴛ 愛 will act lewd with you or with the replied person
➛ /romance*:* Qᴜᴇᴇɴ ʙᴏᴛ 愛 will act all romantic with you or replied person
...
QUEEN_PTB.add_handler(
    DisableAbleMessageHandler(filters.Regex(r"(?i)^cutiepii\?"),
                              ...
                              friendly="decide"))
                              """
QUEEN_PTB.add_handler(DisableAbleCommandHandler("sanitize", sanitize, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("runs", runs, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("slap", slap, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("pat", pat, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("roll", roll, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("toss", toss, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("shrug", shrug, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("bluetext", bluetext, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("rlg", rlg, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("decide", decide, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("8ball", eightball, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("table", table, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("shout", shout, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("weebify", weebify, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("gbun", gbun, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("gbam", gbam, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("cuddle", cuddle, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("flirt", flirt, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("romance", romance, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("uwu", uwu, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("owo", owo, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("kill",kill, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("love", love, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("hack", hack, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("bombs",bombs, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("moonanimation", moonanimation, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("clockanimation", clockanimation, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("blockanimation", blockanimation, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("earthanimation", earthanimation, block=False))
