...
import platform
import sqlalchemy
import Gbot.modules.helper_funcs.git_api as git
...
from Gbot import QUEEN_PTB, pgram, StartTime
from Gbot.__main__ import GDPR
...
from telegram.ext import filters as PTB_Queen_Filters, CommandHandler, CallbackQueryHandler, CallbackContext
...
Markdown is a very powerful formatting tool supported by telegram. Qᴜᴇᴇɴ ʙᴏᴛ 愛 has some enhancements, to make sure that \
...
%%%
how are you</code>
This will randomly choose between sending the first message, "hello", or the second message, "how are you". Use this to make Qᴜᴇᴇɴ ʙᴏᴛ 愛 feel a bit more customised! (only works in notes/filters/greetings)
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="[► Click Here ◄]",
                        url="https://github.com/Awesome-RJ/QueenBot",
                    ),
                ],
            ],
            disable_web_page_preview=True,
...
QUEEN_PTB.add_handler(
    DisableAbleCommandHandler("echo",
                              echo,
                              filters=PTB_Queen_Filters.ChatType.GROUPS,
                              block=False))
QUEEN_PTB.add_handler(
