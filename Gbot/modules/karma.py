...
from Gbot.utils.permissions import adminsOnly
from Gbot.modules.mongo.karma_mongo import (alpha_to_int, get_karma,
                                                      get_karmas, int_to_alpha,
                                                      update_karma)
from Gbot.modules.mongo.karma_mongo import is_karma_on, karma_off, karma_on
...
@pgram.on_message(
    filters.command("karma", "karma@Gbot") & filters.group)
@capture_err
