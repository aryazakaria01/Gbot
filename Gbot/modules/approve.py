...
import html
import Gbot.modules.sql.approve_sql as sql
...
from Gbot import QUEEN_PTB, SUDO_USERS
...
from Gbot.modules.helper_funcs.admin_status import AdminPerms, user_admin_check
...
QUEEN_PTB.add_handler(DisableAbleCommandHandler("approve", approve, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("unapprove", disapprove, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("approved", approved, block=False))
QUEEN_PTB.add_handler(DisableAbleCommandHandler("approval", approval, block=False))
