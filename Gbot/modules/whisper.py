...
from Gbot import telethn as bot
...
@bot.on(events.NewMessage(pattern="^[!?@/]udanpirappumusic_bot$"))
async def stsrt(event):
    await event.reply("**Heya, I am a Whisper Bot function for Queen!**",
...
async def die(event):
    ...
    dn = event.builder.article(
        ...
        description="It's a whisper Bot function for Queen!\n(c) Logi",
        text=
