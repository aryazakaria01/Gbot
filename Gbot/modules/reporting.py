...
from Gbot import LOGGER, SUDO_USERS, WHITELIST_USERS, QUEEN_PTB
from Gbot.modules.log_channel import loggable
from Gbot.modules.sql import reporting_sql as sql
...
QUEEN_PTB.add_handler(CommandHandler("reports", report_setting, block=False))
...
QUEEN_PTB.add_handler(CallbackQueryHandler(buttons, pattern=r"report_", block=False))
