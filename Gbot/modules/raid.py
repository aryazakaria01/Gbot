...
from Gbot.modules.helper_funcs.chat_status import connection_status
from Gbot.modules.cron_jobs import j
...
QUEEN_PTB.add_handler(CommandHandler("raid", setRaid, block=False))
QUEEN_PTB.add_handler(CallbackQueryHandler(enable_raid_cb, pattern=r"enable_raid=", block=False))
QUEEN_PTB.add_handler(CallbackQueryHandler(disable_raid_cb, pattern=r"disable_raid=", block=False))
QUEEN_PTB.add_handler(CallbackQueryHandler(disable_raid_cb, pattern=r"cancel_raid=", block=False))
QUEEN_PTB.add_handler(CommandHandler("raidtime", raidtime, block=False))
QUEEN_PTB.add_handler(CommandHandler("raidactiontime", raidactiontime, block=False))



__mod_name__ = "[✨ ᴀɴᴛɪʀᴀɪᴅ ✨]"
