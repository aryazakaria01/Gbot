...
import Gbot.modules.sql.nsfw_sql as sql
from Gbot import QUEEN_PTB, DEV_USERS
...
QUEEN_PTB.add_handler(CommandHandler("addnsfw", add_nsfw, block=False))
QUEEN_PTB.add_handler(CommandHandler("rmnsfw", rem_nsfw, block=False))
QUEEN_PTB.add_handler(
    CommandHandler("nsfwchats",
                   list_nsfw_chats,
                   filters=filters.User(DEV_USERS),
                   block=False))
QUEEN_PTB.add_handler(CommandHandler("lewdkemo", lewdkemo, block=False))
QUEEN_PTB.add_handler(CommandHandler("neko", neko, block=False))
QUEEN_PTB.add_handler(CommandHandler("feet", feet, block=False))
QUEEN_PTB.add_handler(CommandHandler("yuri", yuri, block=False))
QUEEN_PTB.add_handler(CommandHandler("trap", trap, block=False))
QUEEN_PTB.add_handler(CommandHandler("futanari", futanari, block=False))
QUEEN_PTB.add_handler(CommandHandler("hololewd", hololewd, block=False))
QUEEN_PTB.add_handler(CommandHandler("sologif", sologif, block=False))
QUEEN_PTB.add_handler(CommandHandler("cumgif", cumgif, block=False))
QUEEN_PTB.add_handler(CommandHandler("erokemo", erokemo, block=False))
QUEEN_PTB.add_handler(CommandHandler("lesbian", lesbian, block=False))
QUEEN_PTB.add_handler(CommandHandler("wallpaper", wallpaper, block=False))
QUEEN_PTB.add_handler(CommandHandler("lewdk", lewdk, block=False))
QUEEN_PTB.add_handler(CommandHandler("ngif", ngif, block=False))
QUEEN_PTB.add_handler(CommandHandler("tickle", tickle, block=False))
QUEEN_PTB.add_handler(CommandHandler("lewd", lewd, block=False))
QUEEN_PTB.add_handler(CommandHandler("feed", feed, block=False))
QUEEN_PTB.add_handler(CommandHandler("eroyuri", eroyuri, block=False))
QUEEN_PTB.add_handler(CommandHandler("eron", eron, block=False))
QUEEN_PTB.add_handler(CommandHandler("cum", cum, block=False))
QUEEN_PTB.add_handler(CommandHandler("bjgif", bjgif, block=False))
QUEEN_PTB.add_handler(CommandHandler("bj", bj, block=False))
QUEEN_PTB.add_handler(CommandHandler("nekonsfw", nekonsfw, block=False))
QUEEN_PTB.add_handler(CommandHandler("solo", solo, block=False))
QUEEN_PTB.add_handler(CommandHandler("kemonomimi", kemonomimi, block=False))
QUEEN_PTB.add_handler(CommandHandler("avatarlewd", avatarlewd, block=False))
QUEEN_PTB.add_handler(CommandHandler("gasm", gasm, block=False))
QUEEN_PTB.add_handler(CommandHandler("poke", poke, block=False))
QUEEN_PTB.add_handler(CommandHandler("anal", anal, block=False))
QUEEN_PTB.add_handler(CommandHandler("hentai", hentai, block=False))
QUEEN_PTB.add_handler(CommandHandler("avatar", avatar, block=False))
QUEEN_PTB.add_handler(CommandHandler("erofeet", erofeet, block=False))
QUEEN_PTB.add_handler(CommandHandler("holo", holo, block=False))
QUEEN_PTB.add_handler(CommandHandler("tits", tits, block=False))
QUEEN_PTB.add_handler(CommandHandler("pussygif", pussygif, block=False))
QUEEN_PTB.add_handler(CommandHandler("holoero", holoero, block=False))
QUEEN_PTB.add_handler(CommandHandler("pussy", pussy, block=False))
QUEEN_PTB.add_handler(CommandHandler("hentaigif", hentaigif, block=False))
QUEEN_PTB.add_handler(CommandHandler("classic", classic, block=False))
QUEEN_PTB.add_handler(CommandHandler("kuni", kuni, block=False))
QUEEN_PTB.add_handler(CommandHandler("waifu", waifu, block=False))
QUEEN_PTB.add_handler(CommandHandler("lewd", lewd, block=False))
QUEEN_PTB.add_handler(CommandHandler("kiss", kiss, block=False))
QUEEN_PTB.add_handler(CommandHandler("femdom", femdom, block=False))
QUEEN_PTB.add_handler(CommandHandler("cuddle", cuddle, block=False))
QUEEN_PTB.add_handler(CommandHandler("hug", hug, block=False))
QUEEN_PTB.add_handler(CommandHandler("erok", erok, block=False))
QUEEN_PTB.add_handler(CommandHandler("foxgirl", foxgirl, block=False))
QUEEN_PTB.add_handler(CommandHandler("titsgif", titsgif, block=False))
QUEEN_PTB.add_handler(CommandHandler("ero", ero, block=False))
QUEEN_PTB.add_handler(CommandHandler("smug", smug, block=False))
QUEEN_PTB.add_handler(CommandHandler("baka", baka, block=False))
