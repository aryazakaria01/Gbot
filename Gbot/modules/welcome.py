...
import re
import time
import Gbot.modules.sql.welcome_sql as sql
...
from Gbot.modules.helper_funcs.anonymous import user_admin, AdminPerms
from Gbot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Gbot.modules.helper_funcs.msg_types import get_welcome_type
from Gbot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Gbot.modules.log_channel import loggable
import Gbot.modules.sql.feds_sql as fed_sql
...
import Gbot.modules.sql.log_channel_sql as logsql
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == bot.id:
                ...
                await update.effective_message.reply_text(
                    f"Hey {user.first_name}, I'm Qᴜᴇᴇɴ ʙᴏᴛ 愛! Thank you for adding me to {chat.title}\n"
        ...
        if welcome_bool:
            if media_wel:
                if ENUM_FUNC_MAP[welc_type] == QUEEN_PTB.bot.send_sticker:
...
WELC_HELP_TXT = (
    ...
    "buttons.\n"
    f"To create a button linking to your rules, use this: `[Rules](buttonurl://t.me/Gbot?start=group_id)`. "
