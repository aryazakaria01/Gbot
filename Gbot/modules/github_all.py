...
import Gbot.modules.helper_funcs.git_api as api
import Gbot.modules.sql.github_sql as sql
...
QUEEN_PTB.add_handler(CommandHandler("saverepo", saveRepo, block=False))
QUEEN_PTB.add_handler(CommandHandler("delrepo", delRepo, block=False))
QUEEN_PTB.add_handler(
...
QUEEN_PTB.add_handler(
    DisableAbleCommandHandler("changelog",
                              ...
                              admin_ok=True,
                              block=False))
QUEEN_PTB.add_handler(MessageHandler(r"^&[^\s]+", hashFetch, block=False))
