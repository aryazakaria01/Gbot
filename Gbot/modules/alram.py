from Gbot import LOGGER, mongodb, telethn

from Gbot.events import register
from telethon import *
import dateparser

db = mongodb["Gbot_alarm"]
alarms = db.alarm
...
**NOTE:** Please turn on notifications for @Gbot otherwise you will not get notification for the alarm !
"""
