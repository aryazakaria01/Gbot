...
from Gbot import BOT_ID, OWNER_ID as SUDO_USERS, pgram, QUEEN_PTB
from Gbot.modules.sql import forceSubscribe_sql as sql
            ...
            if client.get_chat_member(chat_id, user_id).status not in (
                ...
                try:
                    ...
                    try:
                        ...
                        sent_message.edit(
                            "❗ **Qᴜᴇᴇɴ ʙᴏᴛ 愛 is not an admin here..**\n__Give me ban permissions and retry.. \n#Ending FSub...__"
                        )
                    except RPCError:
                        return
...
@pgram.on_message(
    filters.command([
        "forcesubscribe", "forcesub", "forcesub@Gbot",
        "forcesubscribe@Gbot"
    ]) & ~filters.private)
...
__help__ = """
*Force Subscribe*:
- Qᴜᴇᴇɴ ʙᴏᴛ 愛 can mute members who are not subscribed your channel until they subscribe
