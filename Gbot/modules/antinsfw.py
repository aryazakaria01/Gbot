...
from Gbot import SUDO_USERS, arq, pgram
from Gbot.utils.errors import capture_err
from Gbot.utils.permissions import adminsOnly
from Gbot.modules.mongo.nsfw_mongo import is_nsfw_on, nsfw_off, nsfw_on
...
@pgram.on_message(filters.command(["nsfwscan", "nsfwscan@Gbot"]))
@capture_err
