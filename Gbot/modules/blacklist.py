...
import Gbot.modules.sql.blacklist_sql as sql
from Gbot import QUEEN_PTB, LOGGER
...
from Gbot.modules.helper_funcs.chat_status import user_not_admin

from Gbot.modules.helper_funcs.extraction import extract_text
from Gbot.modules.helper_funcs.misc import split_message
from Gbot.modules.helper_funcs.string_handling import extract_time
from Gbot.modules.log_channel import loggable
from Gbot.modules.redis.approvals_redis import is_approved
from Gbot.modules.warns import warn
from Gbot.modules.helper_funcs.anonymous import AdminPerms
...
QUEEN_PTB.add_handler(CommandHandler("addblacklist", add_blacklist, block=False))
QUEEN_PTB.add_handler(CommandHandler("unblacklist", unblacklist, block=False))
QUEEN_PTB.add_handler(CommandHandler("blacklistmode", blacklist_mode, block=False))
QUEEN_PTB.add_handler(
    MessageHandler(
