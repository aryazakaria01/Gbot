...
async def get_user_id(username):
    ...
    for user_obj in users:
        try:
            userdat = await QUEEN_PTB.bot.get_chat(user_obj["_id"])
...
#QUEEN_PTB.add_handler(MessageHandler(filters.ALL & filters.ChatType.GROUPS, chat_checker))
QUEEN_PTB.add_handler(CommandHandler("groups", chats, block=False))
