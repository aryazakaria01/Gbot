...
from Gbot.modules.disable import DisableAbleMessageHandler
from Gbot.modules.helper_funcs.regex_helper import infinite_loop_check
...
QUEEN_PTB.add_handler(DisableAbleMessageHandler(filters.Regex(f's([{"".join(DELIMITERS)}]).*?\\1.*'), sed, friendly="sed", block=False))
"""