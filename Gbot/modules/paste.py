...
from Gbot import pgram, aiohttpsession
from Gbot.utils.errors import capture_err
from Gbot.utils.pastebin import paste

pattern = re.compile(r"^text/|json$|yaml$|xml$|toml$|x-sh$|x-shellscript$")
Queen_PYRO_Paste = filters.command("paste")
...
@pgram.on_message(Queen_PYRO_Paste)
@pgram.on_edited_message(Queen_PYRO_Paste)
@capture_err
