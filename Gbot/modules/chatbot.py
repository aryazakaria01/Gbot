...
from Gbot import BOT_ID, QUEEN_PTB, DEV_USERS
...
def chatbot_response(query: str) -> str:
    data = requests.get(
        f"https://www.kukiapi.xyz/api/apikey=5349869477-KUKIhU1ygu8mm0/Queen/@Awesome_RJ/message={query}"
    )
...
__help__ = """
Chatbot utilizes the Brainshop's API and allows Qᴜᴇᴇɴ ʙᴏᴛ 愛 to talk and provides a more interactive group chat experience.
