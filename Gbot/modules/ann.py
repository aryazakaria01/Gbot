...
from Gbot import OWNER_ID, QUEEN_PTB
from Gbot.modules.log_channel import loggable

import Gbot.modules.sql.logger_sql as sql
...
QUEEN_PTB.add_handler(ChatMemberHandler(chatmemberupdates,
                                           ChatMemberHandler.CHAT_MEMBER),
                         group=-21)
QUEEN_PTB.add_handler(ChatMemberHandler(mychatmemberupdates,
                                           ChatMemberHandler.MY_CHAT_MEMBER),
                         group=-23)
QUEEN_PTB.add_handler(ChatMemberHandler(botstatchanged,
                                           ChatMemberHandler.MY_CHAT_MEMBER),
                         group=-25)
QUEEN_PTB.add_handler(ChatMemberHandler(admincacheupdates,
                                           ChatMemberHandler.CHAT_MEMBER),
                         group=-22)
"""