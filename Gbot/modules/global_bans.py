...
import Gbot.modules.sql.global_bans_sql as sql
from Gbot import (
    SUPPORT_USERS,
    DEV_USERS,
    GBAN_LOGS,
...
from Gbot.modules.helper_funcs.misc import send_to_list
...
QUEEN_PTB.add_handler(CommandHandler("gban", gban, block=False))
QUEEN_PTB.add_handler(CommandHandler("ungban", ungban, block=False))
QUEEN_PTB.add_handler(CommandHandler("gbanlist", gbanlist, block=False))
...
QUEEN_PTB.add_handler(MessageHandler((filters.ALL & filters.ChatType.GROUPS), enforce_gban, block=False))
