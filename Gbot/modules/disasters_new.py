...
from Gbot.modules.helper_funcs.chat_status import dev_plus, sudo_plus, whitelist_plus
...
__mod_name__ = "[✨ ꜱᴜᴘᴇʀ ᴜꜱᴇʀꜱ ✨]"

QUEEN_PTB.add_handler(CommandHandler("addsudo", addsudo, block=False))
QUEEN_PTB.add_handler(CommandHandler("removesudo", removesudo, block=False))
QUEEN_PTB.add_handler(CommandHandler("addsupport", addsupport, block=False))
QUEEN_PTB.add_handler(CommandHandler("removesupport", removesupport, block=False))
QUEEN_PTB.add_handler(CommandHandler("addwhitelist", addwhitelist, block=False))
QUEEN_PTB.add_handler(CommandHandler("removewhitelist", removewhitelist, block=False))
QUEEN_PTB.add_handler(CommandHandler(("devlist"), devlist, block=False))
QUEEN_PTB.add_handler(CommandHandler(("sudolist"), sudolist, block=False))
QUEEN_PTB.add_handler(CommandHandler(("supportlist"), supportlist, block=False))
QUEEN_PTB.add_handler(CommandHandler(("whitelistlist"), whitelistlist, block=False))
