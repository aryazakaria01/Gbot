...
import Gbot.modules.sql.global_bans_sql as gban_sql
import Gbot.modules.sql.users_sql as user_sql

from time import sleep
from Gbot import DEV_USERS, OWNER_ID, QUEEN_PTB
...
QUEEN_PTB.add_handler(DB_CLEANUP_HANDLER)
QUEEN_PTB.add_handler(BUTTON_HANDLER)
