...
from Gbot.modules.helper_funcs.admin_status import user_is_admin
from Gbot.modules.sql.notes_sql import Buttons
...
ENUM_FUNC_MAP = {
    Types.TEXT.value: QUEEN_PTB.bot.send_message,
    Types.BUTTON_TEXT.value: QUEEN_PTB.bot.send_message,
    Types.STICKER.value: QUEEN_PTB.bot.send_sticker,
    Types.DOCUMENT.value: QUEEN_PTB.bot.send_document,
    Types.PHOTO.value: QUEEN_PTB.bot.send_photo,
    Types.AUDIO.value: QUEEN_PTB.bot.send_audio,
    Types.VOICE.value: QUEEN_PTB.bot.send_voice,
    Types.VIDEO.value: QUEEN_PTB.bot.send_video,
}
