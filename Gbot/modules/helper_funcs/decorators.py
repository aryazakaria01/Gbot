"""
from Gbot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from Gbot import LOGGER, QUEEN_PTB as app
...
cutiepii_cmd = Queen_TG_Handler(app).command
cutiepii_msg = Queen_TG_Handler(app).message
cutiepii_callback = Queen_TG_Handler(app).callbackquery
cutiepii_inline = Queen_TG_Handler(app).inlinequery
