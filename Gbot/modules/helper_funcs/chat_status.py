...
from Gbot.modules.helper_funcs.admin_status import bot_is_admin
...
async def is_user_admin(update: Update,
    ...
    if not member:
        ...
        try:
            ...
            chat_admins = await QUEEN_PTB.bot.getChatAdministrators(chat.id)
...
from Gbot.modules import connection
