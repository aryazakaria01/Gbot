...
from Gbot import OWNER_ID, pgram, arq, QUEEN_PTB , BOT_USERNAME
from Gbot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from Gbot.utils.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[ Owner 💜](https://t.me/ROWDY_OF_PLUS):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](https://telegram.dog/{BOT_USERNAME}) | [UBOT](https://telegram.dog/logi_channel)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
